...
$(echo results/epistasis_models/epistasis_models_01_10_1_{1..32}.txt results/epistasis_models/epistasis_models_01_10_2_{1..32}.txt results/epistasis_models/epistasis_models_11_00_{1..32}.txt)
