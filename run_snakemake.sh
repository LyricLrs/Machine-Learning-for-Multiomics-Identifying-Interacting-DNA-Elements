...
snakemake -c 4 --use-conda --jobs 32 --cluster 'sbatch -W 48:00 -n 8 -R "rusage[mem=16G]" -o out.%J.txt -e err.%J.txt' results/SCENT_peak_gene/significant_peak_gene_associations.csv
