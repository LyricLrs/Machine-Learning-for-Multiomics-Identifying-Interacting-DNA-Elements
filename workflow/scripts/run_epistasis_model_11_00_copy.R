...
files <- list.files(path = "data_processing/11_pairs", pattern = "\\.csv$", full.names = TRUE)
for (file in files) {
...
write.csv(results, 'results/results/model_results_cells_copy_11.csv', row.names = FALSE)